...
__unused static const char startBackgroundColorKey;
...
@property (nonatomic, assign) CATransform3D         startTransform3D;
@property (nonatomic, assign) CGFloat               startAlpha;
@property (nonatomic, assign) BOOL                  startUserInteractionEnabled;
@end
